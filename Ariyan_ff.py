...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Ariyan Ahmed
\033[1;37m Facebook:            Ariyan Ahmed
\033[1;37m Github  :            Ariyan_Ssb
...
def cutter():
    ...
    print(47*'-')
    input(f"{S} Press Enter To Back Ariyan Menu ")
    SSB(allkey)       
